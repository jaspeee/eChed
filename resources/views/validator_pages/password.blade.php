    ...
    <div class="row">
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" action="/validator/changepass" autocomplete="off">
            {{method_field('patch')}}
             @csrf
            ...
            <div class="card-footer ">
              <button type="submit"  onclick="return confirmation();" class="btn btn-success btn-round">{{__('Change Password')}}</button>
            </div>
          </form>
        </div>
      </div>
