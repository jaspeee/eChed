                  ...
                  <table class="table" id="institutionstbl">
                      ...
                      <tbody> 
                            ...
                            <tr>
                                ...
                                <td> 
                                  @if($ins->type == 'SUC')
                                    <span class="badge badge-primary badge-pill" style="background-color: #FFBF00;">{{$ins->vcount}} / 7</span>
                                  @elseif($ins->type == 'NON-SUC')
                                    <span class="badge badge-primary badge-pill" style="background-color: #FFBF00;">{{$ins->vcount}} / 4</span>
                                  @endif
                                </td>
                                <td>
                                  @if($ins->type == 'SUC')
                                ...
                                <td>
                                    <a href="/verifier/verify/{{$ins->institutions_id}}">
